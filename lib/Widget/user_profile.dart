    ...
    AlertDialog alertDialog = new AlertDialog(
      ...
      actions: <Widget>[
        ...
        new FlatButton(
          ...
          onPressed: () {
            setState(() {
              addPhone(user, value) != null ? _infor.phone = value : print(
                  "eror");
            });
            Navigator.of(context, rootNavigator: true).pop();
          },
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<OrderNotifier>(context, listen: false);
      ...
      _infor = orderNotifier.infor;
          ...
          if(_infor!=null ) return Container(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      _showDialogAddress(
                          _infor.address, authNotifier.user.email);
                    },
                    child: Text(" Address  : ",
                        style: TextStyle(color: Colors.white, fontSize: 20)),
                ...
                Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          _showDialogPhone(
                              _infor.phone, authNotifier.user.email);
                        },
                        child: Text(" Phone      : ",
                            style: TextStyle(
